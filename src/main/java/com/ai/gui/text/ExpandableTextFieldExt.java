...
import com.ai.gui.PromptAttachmentHandler;
...
import static com.ai.gui.text.NewlineFilter.NEWLINE_REPLACEMENT;
...
public class ExpandableTextFieldExt extends ExtendableTextField implements Expandable, DataProvider {
    public static final DataKey<PromptAttachmentHandler> PROMPT_ATTACHMENT_HANDLER_KEY = DataKey.create("Magical AI.ai.PromptAttachmentHandler");
